		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="index.html"><i class='bx bx-radio-circle'></i>Total Products</a>
						</li>
						<li> <a href="index2.html"><i class='bx bx-radio-circle'></i>Low Stock Alerts</a>
						</li>
						<li> <a href="index3.html"><i class='bx bx-radio-circle'></i>Sales Summary</a>
						</li>
						<li> <a href="index3.html"><i class='bx bx-radio-circle'></i>Pie/Bar Chart of Stock Status</a>
						</li>
					</ul>
				</li>
				<li>
