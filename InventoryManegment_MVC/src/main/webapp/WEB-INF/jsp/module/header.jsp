...
<!-- Mirrored from codervent.com/rocker/demo/vertical/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Mar 2025 04:51:42 GMT -->
<head>
<!-- Required meta tags -->
<meta charset="utf-8">
...
<title>Inventory Manegament system</title>
</head>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<!-- <img src="resources/assets/images/img.jpg" class="logo-icon"
						alt="logo icon" style="width: 200px; height: 50px;"> -->
						  <h4 class="fw-bold text-white text-uppercase lh-base" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.2);">
    IMS Software
</h4>
				</div>
				<!-- <div>
			...
			<ul class="metismenu" id="menu">
				<li><a href="javascript:;" class="has-arrow">
					...
					<ul>
						<li><a href="index.html"><i class='bx bx-radio-circle'></i>Total
								Products</a></li>
						<li><a href="index2.html"><i class='bx bx-radio-circle'></i>Low
								Stock Alerts</a></li>
						<li><a href="index3.html"><i class='bx bx-radio-circle'></i>Sales
								Summary</a></li>
						<li><a href="index3.html"><i class='bx bx-radio-circle'></i>Pie/Bar
								Chart of Stock Status</a></li>
					</ul></li>
				<li><a href="javascript:;" class="has-arrow">
						<div class="parent-icon">
					...
					<ul>
						<li><a href="productsdata"><i class='bx bx-radio-circle'></i>Add
								New Item</a></li>
						<li><a href="getAll"><i class='bx bx-radio-circle'></i>View
								Inventory </a></li>
						<li><a href="ProductDelete"><i class='bx bx-radio-circle'></i>Edit/Delete
						</a></li>
				...
				<li><a href="javascript:;" class="has-arrow">
					...
					<ul>
						<li><a href="supplier"><i class='bx bx-radio-circle'></i>Add
								Suppliers</a></li>
						<li><a href="view"><i class='bx bx-radio-circle'></i>View
								Suppliers</a></li>
				...
				<li><a href="javascript:;" class="has-arrow">
					...
					<ul>
						<li><a href="Purchase"><i class='bx bx-radio-circle'></i>Add
								Purchase</a></li>
						<li><a href="getAllPurchase"><i
								class='bx bx-radio-circle'></i>View Purchase</a></li>
				...
				<li><a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li><a href="Add_maneger"><i class='bx bx-radio-circle'></i>Add/remove
								Manegers</a></li>
						<li><a href="ViewManeger"><i class='bx bx-radio-circle'></i>View
								all users</a></li>
				...
				<li><a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li><a href="Add_stocks"><i class='bx bx-radio-circle'></i>Add
								Stocks</a></li>
						<li><a href="Viewstocks"><i class='bx bx-radio-circle'></i>View
								Stock_Out </a></li>
				...
				<li><a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li><a href="viewStockReports"><i
								class='bx bx-radio-circle'></i>Stock Reports</a></li>
						<li><a href="lowStock"><i class='bx bx-radio-circle'></i>Low
								stock Reports</a></li>
						<li><a href="getPurchaseData"><i
								class='bx bx-radio-circle'></i>Purchase Report </a></li>
						<li><a href="getSaleReport"><i class='bx bx-radio-circle'></i>Sale_Out
								Report </a></li>

					</ul></li>
				<li><a href="filterData">
						<div class="parent-icon">
				...
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="user-box dropdown px-3">
						<a
							...
							src="resources/assets/images/avatars/avatar-2.png"
